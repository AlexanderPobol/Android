...
public class StartActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button butRus;
    private Button butRusOff;
    private Button butEn;
    private Button butEnOff;
    private Button butRobotCtrl;
    private Button butLogin;
    private Button butRegistr;
    private TextView tvEn;
    private TextView tvRus;
    private Boolean localeTune;
    private Boolean langE;
    private String lang;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.but_robot_control:
                ...
                startActivity(new Intent(StartActivity.this, VictorinaActivity.class));
                break;
        }
    }
